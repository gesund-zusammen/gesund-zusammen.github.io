...
interface IAcceleratorPageHeaderProps {
  title: string;
  content: string;
}

class AcceleratorPageHeader extends React.PureComponent<
  IAcceleratorPageHeaderProps,
  {}
> {
  render = () => {
    return (
...
export default AcceleratorPageHeader;
