    ...
    return (
      <PrivacyWrapper paddingBottom={4}>
        ...
        <Typography variant="body1">
          ...
          E-Mail-Adresse: <Link href="mailto:privacy@gesund-zusammen.de">privacy@gesund-zusammen.de</Link><br />
          Telefonnummer<br />
        </Typography>
        <Typography variant="h2" id="section1">
        ...
        <Typography variant="body1">
          ...
          <br />
          Sie können die Speicherung der Cookies durch eine entsprechende Einstellung Ihrer Browser-Software verhindern; wir weisen Sie jedoch darauf hin, dass Sie in diesem Fall gegebenenfalls nicht sämtliche Funktionen dieser Website vollumfänglich nutzen können. Sie können darüber hinaus die Erfassung der durch das Cookie erzeugten und auf Ihre Nutzung der Website bezogenen Daten (inkl. Ihrer IP-Adresse) an Google sowie die Verarbeitung dieser Daten durch Google verhindern, indem Sie das unter der URL <Link href="https://tools.google.com/dlpage/gaoptout?hl=de">https://tools.google.com/dlpage/gaoptout?hl=de</Link><br /> verfügbare Browser-Plug-in herunterladen und installieren.
          <br />
          ...
          <br />
          <Link href="https://support.google.com/analytics/answer/6004245?hl=de">https://support.google.com/analytics/answer/6004245?hl=de</Link><br />
        </Typography>
        <Typography variant="h2" id="section1">
          Goolge Web Fonts
        </Typography>
        <Typography variant="body1">
          ...
          <br />
          Weitere Informationen zum Datenschutz können Sie der Datenschutzerklärung von Google entnehmen:<br />
          <Link href="http://www.google.de/intl/de/policies/privacy">http://www.google.de/intl/de/policies/privacy</Link>
          <br />Weitergehende Informationen zu Google Web Fonts finden Sie unter<br />
          <Link href="http://www.google.com/webfonts/">http://www.google.com/webfonts/</Link>,
          <Link href="https://developers.google.com/fonts/faq?hl=de-DE&csw=1">https://developers.google.com/fonts/faq?hl=de-DE&csw=1</Link><br /> und <Link href="https://www.google.com/fonts#AboutPlace:about">https://www.google.com/fonts#AboutPlace:about</Link>.
        </Typography>
        <Typography variant="h2" id="section1">
        ...
        <Typography variant="body1">
          Im Folgenden finden Sie Informationen dazu, welche Betroffenenrechte das geltende Datenschutzrecht Ihnen gegenüber dem Verantwortlichen hinsichtlich der Verarbeitung Ihrer personenbezogenen Daten gewährt:<br />
          ...
          Das Recht, gemäß Art. 16 DSGVO unverzüglich die Berichtigung unrichtiger oder Vervollständigung Ihrer bei uns gespeicherten personenbezogenen Daten zu verlangen.<br />
          ...
          Das Recht, gemäß Art. 20 DSGVO Ihre personenbezogenen Daten, die Sie uns bereitgestellt haben, in einem strukturierten, gängigen und maschinenlesebaren Format zu erhalten oder die Übermittlung an einen anderen Verantwortlichen zu verlangen.<br />
          Das Recht, sich gemäß Art. 77 DSGVO bei einer Aufsichtsbehörde zu beschweren. In der Regel können Sie sich hierfür an die Aufsichtsbehörde des Bundeslandes unseres oben angegebenen Sitzes oder ggf. die Ihres üblichen Aufenthaltsortes oder Arbeitsplatzes wenden.<br />
        ...
        <Typography variant="body1">
          <b>Sofern Ihre personenbezogenen Daten von uns auf Grundlage von berechtigten Interessen gemäß Art. 6 Abs. 1 S. 1 lit. f DSGVO verarbeitet werden, haben Sie gemäß Art. 21 DSGVO das Recht, Widerspruch gegen die Verarbeitung Ihrer personenbezogenen Daten einzulegen, soweit dies aus Gründen erfolgt, die sich aus Ihrer besonderen Situation ergeben. Soweit sich der Widerspruch gegen die Verarbeitung personenbezogener Daten zum Zwecke von Direktwerbung richtet, haben Sie ein generelles Widerspruchsrecht ohne das Erfordernis der Angabe einer besonderen Situation.
          </b><br />Möchten Sie von Ihrem Widerrufs- oder Widerspruchsrecht Gebrauch machen, genügt eine E-Mail an media@gesund-zussammen.de.
        </Typography>
        <Typography variant="h2" id="section1">
