    ...
    return (
      <PrivacyWrapper paddingBottom={4}>
        ...
        <Typography variant="body1">
          ...
          Bereitstellung unserer Dienste. Andere Cookies werden nur mit Ihrer
          Einwilligung auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO gespeichert.
          Die Einwilligung ist jederzeit für die Zukunft widerrufbar. Die
          Rechtsgrundlage kann sich auch aus Art. 6 Abs. 1 lit. b DSGVO ergeben,
          falls die Verarbeitung für die Erfüllung eines Vertrags, dessen
          ...
          <Link href="#uc-central-modal-show">Cookie Settings</Link> oder Ihren
          Browser so einstellen, dass Sie
          <br />
          ...
          .<br />
          Die meisten Browser bieten zudem eine sog. „Do-Not-Track-Funktion“ an.
          ...
          Sie über den Anbieter Ihres Browsers (z. B. für Mozilla Firefox unter:{" "}
        ...
        <Typography variant="body1">
          ...
          inklusive der von Ihnen dort angegebenen Vor- und Nachname, Anrede,
          Postanschrift zwecks Bearbeitung der Anfrage und für den Fall von
          Anschlussfragen bei uns gespeichert. Die Angabe einer E-Mail-Adresse
          ist zur Kontaktangabe erforderlich, die Angabe Ihres Namens sowie
          Ihrer Telefonnummer ist freiwillig. Diese Daten geben wir in keinem
          Fall ohne Ihre Einwilligung weiter. Rechtsgrundlage für die
          Verarbeitung der Daten ist unser berechtigtes Interesse an der
          Beantwortung Ihres Anliegens gemäß Art. 6 Abs. 1 lit. f DSGVO sowie
          ggf. Art. 6 Abs. 1 lit. b DSGVO, sofern Ihre Anfrage auf den Abschluss
          eines Vertrages abzielt. Ihre Daten werden nach abschließender
          Bearbeitung Ihrer Anfrage gelöscht, sofern keine gesetzlichen
          Aufbewahrungspflichten entgegenstehen. Sie können im Falle von Art. 6
          Abs. 1 lit. f DSGVO gegen die Verarbeitung Ihrer personenbezogenen
          Daten jederzeit Widerspruch einlegen.
        </Typography>
        <Typography variant="h2" id="section1">
          Google Analytics
        </Typography>
        <Typography variant="body1">
          ...
          übertragen und dort gespeichert. Wir setzen Google Analytics nur mit
          ...
          Europäischen Wirtschaftsraum gekürzt, wodurch eine
          ...
          gewährleistet. Soweit Sie hierzu Ihre Einwilligung nach Art. 6 Abs. 1
          S. 1 lit. a DSGVO erteilt haben, erfolgt die Verarbeitung auf dieser
          Website zum Zweck der Websiteanalyse. Im Auftrag des Betreibers dieser
          ...
          Google zusammengeführt. Die Nutzungsbedingungen von Google Analytics
          und Informationen zum Datenschutz können über die folgenden Links
          abgerufen werden: http://www.google.com/analytics/terms/de.html sowie
        ...
        <Typography variant="body1">
          ...
          anzeigen kann. Wenn ihr Browser diese Funktion nicht unterstützt, wird
          eine Standardschrift von ihrem Computer zur Anzeige genutzt. Die
          ...
          übermittelt, welche Seite unseres Internetauftritts Sie besucht haben.
          Auch wird die IP-Adresse des Browsers des Endgerätes des Besuchers von
          Google gespeichert.
          <br />
          ...
          <br />
          (3) Hierin liegt auch unser berechtigtes Interesse nach Art. 6 Abs. 1
          lit. f DSGVO.
          <br />
